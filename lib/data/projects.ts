...
export const projects: Project[] = [
  ...
  {
    id: 'Devs Open Source',
    title: 'Devs Open Source',
    description: 'A minimal, opinionated MVP you can clone and launch locally in minutes.',
    details: 'Includes: auth, blog CRUD, public API endpoints, admin dashboard, responsive UI, and a small WYSIWYG-ready editor scaffold.',
    tags: ['Node.js', 'Express', 'MongoDB', 'Tailwind'],
    repo: 'https://github.com/silassdev/laravel-mvp',
    image: '/github.png',
  },
  {
  ...
  },
  {
    ...
    live: 'https://task-manager-ashen.vercel.app/',
    image: '/task.png',
  },
  {
  ...
  },
  {
    ...
    description: 'A fullstack blog management application.',
    details: 'A fullstack blog management application built with Next.js, TypeScript, and MongoDB.',
    tags: ['Next.js', 'Node/Express', 'TypeScript', 'MongoDB', 'Tailwind'],
    live: 'https://blog-management-ashen.vercel.app/',
    image: '/github.png',
  },
  {
